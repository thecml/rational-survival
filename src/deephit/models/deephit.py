...
from deephit.models import pmf
from deephit.models.data import *
from deephit.models.loss import *
from deephit.models.utils import pad_col

class DeepHitSingle(pmf.PMFBase):
